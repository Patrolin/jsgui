"use strict";
function generateFontSizeCssVars(start, names, maxOffset) {
...
function generateColorCssVars(start, count) {
    if (start === void 0) { start = 0.874; }
    if (count === void 0) { count = 4; }
    var acc = "  /* generated by generateColorCssVars */";
    for (var i = 0; i < count; i++) {
        var alpha = start * Math.pow((0.5), i);
        var name_2 = (i > 0) ? "gray-".concat(i) : "gray";
        acc += "\n  --".concat(name_2, ": rgba(0, 0, 0, ").concat(alpha.toFixed(3), ");");
    }
    // TODO: blue/red
    return acc;
}
...
var MAIN_PAGE_SECTIONS = [
    {
        ...
        onRender: function (wrapper) {
            for (var _i = 0, _a = [undefined, "https://www.google.com"]; _i < _a.length; _i++) {
                ...
                row.append(span("Small", { fontSize: "small", href: href }));
                row.append(span("Normal", { fontSize: "normal", href: href }));
                row.append(span("Big", { fontSize: "big", href: href }));
                row.append(span("Bigger", { fontSize: "bigger", href: href }));
            }
        }
    },
    {
