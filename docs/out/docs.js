/* basicComponents.ts */
window.htmlSection = makeComponent(function htmlSection() {
...
window.spanSection = makeComponent(function spanSection() {
...
window.buttonSection = makeComponent(function buttonSection() {
...
window.iconSection = makeComponent(function spanSection() {
  let row = this.append(div({className: "displayRow", style: {marginTop: -4}}));
...
window.dialogSection = makeComponent(function dialogSection() {
...
window.popupSection = makeComponent(function popupSection() {
...
window.mediaQuerySection = makeComponent(function mediaQuerySection() {
...
window.BASIC_COMPONENT_SECTIONSNone/*: MainPageSection[] */= [
  {
    label: "HTML elements",
    id: "html",
...
/* inputs.ts */
window.textInputSection = makeComponent(function textInputSection() {
...
window.tableSection = makeComponent(function tableSection() {
...
window.testKeysComponent = makeComponent(function testKeysComponent(_/*: BaseProps*/) {
  this.append(span(""));
});

window.INPUT_SECTIONSNone/*: MainPageSection[] */= [
  {
    label: "Text input",
    id: "textInput",
...
/* mainPage.ts */
window.MAIN_PAGE_SECTIONSNone/*: MainPageSection[] */= [
  ...BASIC_COMPONENT_SECTIONS,
  ...INPUT_SECTIONS,
];
window.mainPage = makeComponent(function mainPage() {
...
/* notFoundPage.ts */
window.notFoundPage = makeComponent(function notFoundPage() {
  this.append(span("Page not found"));
});
/* routes.ts */
window.GITHUB_PAGES_PREFIX = "(/jsgui)?";
window.ROUTES = [
  {
...
window.root = makeComponent(function root() {
  this.append(
    router({
...
window.pageWrapper = makeComponent(function pageWrapper(props/*: PageWrapperProps*/) {
...
renderRoot(root());
/* themeCreatorPage.ts */
window.themeCreatorPage = makeComponent(function themeCreatorPage() {
...
window.colorPalette = makeComponent(function colorPalette(props/*: ColorPaletteProps*/) {
...
window.getSizeLabel = function getSizeLabel(size: string) {
